...
export default function AddOwnerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.firstName || !formData.lastName || !formData.nationalId || !formData.email || !formData.password) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || "Sahip eklenirken hata oluştu");
      }
    } catch (err) {
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900">➕ Yeni Sahip Ekle</h1>
          </div>
        </div>
      </header>
